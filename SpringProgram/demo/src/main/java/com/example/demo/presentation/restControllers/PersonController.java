...
public class PersonController {
     ...
     * This method allows an existing reviwer to specify their pnr and email
     * 
     * @param personId The reviwerer to update, TODO replace this with auth based id
     *                 retrival if possible
    ...
    public String UpdateApplicant(@RequestParam String pnr, @RequestParam String username, @RequestParam String password) {

        LOGGER.info("Update of username and password for applicant with pnt (`{}`) to username (`{}`) requested",pnr,username); //TODO add authentication info here, aka who accessed this
        return personService.UpdateApplicant(pnr,username,password);
    }
